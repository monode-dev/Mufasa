...
// function defineLocalCache(objFormat: ObjFormats) {
...
//     } = {};
//     for (const collectionName in objFormat) {
//       objectSubscriptions[collectionName] = [];
...
//             cache[collectionName][docPath] = docData;
//           } else if (change.type === "modified") {
//             cache[collectionName][docPath] = docData;
//           } else if (change.type === "removed") {
//             delete cache[collectionName][docPath];
//           }
//           objectSubscriptions[collectionName].forEach((callback) => {
//             callback(change);
//           });
//         });
//       });
