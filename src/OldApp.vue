...
<template>
  ...
  >
    <Transition>
      <div
        v-if="currentPage === pages.autoUpdate"
        :style="{
    ...
    <Transition>
      <div
        v-if="currentPage === pages.home || currentPage === pages.settings"
        :style="{
          background: `transparent`,
          width: `100%`,
          height: `100%`,
    ...
    <Transition appear @enter="settingsEnter" @leave="settingsLeave">
      <div
    ...
    <Transition appear @enter="offlineEnter" @leave="offlineLeave">
      <div
        v-if="!hasInternet"
        :style="{
          background: `transparent`,
