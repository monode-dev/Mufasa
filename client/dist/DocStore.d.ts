...
export declare namespace Device {
    ...
    type DirectoryPersister = {
        ...
        export: (outputPath: string, shouldInclude: (filePath: string) => boolean) => Promise<void>;
    };
    type JsonPersister = {
    ...
    type Json = string | number | boolean | undefined | null | Json[] | JsonObj;
    type JsonObj = {
        [key: string]: Json;
    };
...
export declare namespace Cloud {
    ...
    type WorkspacePersister = {
        setupWatcher: (batchUpdate: (updates: UpdateBatch) => void, localMetaDataPersister: Device.JsonPersister) => {
            start: () => void;
            stop: () => Promise<void>;
        };
