import { initializeDocClass, Doc, prop, getStoreBank } from "./Doc";
import { PersistanceConfig, Persistance } from "./DocStore";
...
class File extends Doc {
  ...
  readonly fileIsUploaded = prop(Boolean, false, {
    persistance: Persistance.local,
  });
  readonly fileIsDownloaded = prop(Boolean, false, {
    persistance: Persistance.local,
  });
